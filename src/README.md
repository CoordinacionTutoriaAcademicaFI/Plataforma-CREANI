...
## Clonar y levantar
```bash
git clone https://github.com/CoordinacionTutoriaAcademicaFI/Plataforma-CREANI.git
cd Plataforma-CREANI

# Variables
cp src/.env.example src/.env         # Windows PowerShell: copy .\src\.env.example .\src\.env
